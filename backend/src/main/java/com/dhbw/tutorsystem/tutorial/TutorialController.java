...
public class TutorialController {
        ...
        public ResponseEntity<?> findTutorialsWithFilter(Pageable pageable,
                ...
                // specialisationCourseRepository
                // .findAllById((Iterable<Integer>)
                // filterRequest.getSpecialisationCourseIds().iterator());
                ...
                // // only to date specified: default to starting date 2 months in the past
                // until
                // // specified date
                // startsWithinTimeFrame.and(
                ...
                // BlazeJPAQuery
                // JPAQuery<Tutorial> query1 = queryFactory
                // .selectFrom(tutorial)
                // .where(
                // textMatches
                ...
                PagedList<Tutorial> page = cbf.create(
                                ...
                                .where("t.title").like().value("Test%").noEscape()
                                .page(6, 3)
                                .getResultList();
